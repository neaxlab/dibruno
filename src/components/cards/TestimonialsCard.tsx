...
export default function TestimonialsCard({ testimonial }: { testimonial: Testimonial }) {
    return (
        <article className="relative group flex flex-col gap-4 w-full max-w-[466px] h-[596px] text-primary-olive text-d-products hover:cursor-pointer">
            <div className="relative w-full sm:h-[596px] h-[435px] group-hover:h-[435px] overflow-hidden bg-primary-bright rounded-lg transition-all duration-300 ease-in-out">
            ...
            <div className="absolute bottom-0 left-0 w-full sm:h-0 h-[150px] group-hover:h-[150px] bg-primary-lotion transition-all duration-300 ease-in-out overflow-hidden">
